...
const features = [
	...
	"Dashboard with sidebar navigation and user management",
	"Profile settings with theme toggle and password updates",
	"CRUD operations template for project management",
	"Next.js Cache Components for optimal performance",
];
			...
			>
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-24 items-center">
					...
					<div className="flex flex-col">
						...
						>
							Launch your next idea faster with SupaNext Starter Kit 2 — a modern
							boilerplate powered by Next.js 16 and Supabase. Skip the setup
							headaches and focus on building features that matter.
						</motion.p>
