...
import {
    ...
    Monitor,
    MoveDownRight,
    MoveUpRight, User2Icon, RefreshCcwIcon
} from "lucide-react";
        ...
        <div>
            ...
            <div className="grid auto-rows-auto grid-cols-3 gap-5 md:grid-cols-3 lg:grid-cols-4 mb-4">
                <Card className="@container/card">
                    ...
                    <CardFooter className="flex-col items-start gap-1.5 text-sm">
                        <div className="line-clamp-1 flex gap-2 font-medium">
                            Trending up this month <MoveUpRight className="size-4"/>
                        </div>
                ...
                <Card className="@container/card">
                    ...
                    <CardFooter className="flex-col items-start gap-1.5 text-sm">
                        <div className="line-clamp-1 flex gap-2 font-medium">
                            Down 20% this period <MoveUpRight className="size-4"/>
                        </div>
                        <div className="text-muted-foreground">
                ...
                <Card className="@container/card">
                    ...
                    <CardFooter className="flex-col items-start gap-1.5 text-sm">
                        <div className="line-clamp-1 flex gap-2 font-medium">
                            Strong user retention <MoveUpRight className="size-4"/>
                        </div>
                ...
                <Card className="@container/card">
                    ...
                    <CardFooter className="flex-col items-start gap-1.5 text-sm">
                        <div className="line-clamp-1 flex gap-2 font-medium">
                            Steady performance increase <MoveUpRight className="size-4"/>
                        </div>
